...
public class MainActivity extends AppCompatActivity {
    ...
    private CircleImageView homeImage, awayImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeInput = findViewById(R.id.home);
        awayInput = findViewById(R.id.away);
        homeImage = findViewById(R.id.home_img);
        awayImage = findViewById(R.id.away_img);
        ...
        awayInput.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
